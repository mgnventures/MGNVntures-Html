(function($) {
	...
	var validateForm = function(){
		...
		if(cnumber.val() == ""){
			cnumber.next(".error").fadeIn();
		}
		else{
			cnumber.next(".error").fadeOut();
		}
		
		if(services.val() == ""){
			services.next(".error").fadeIn();
		}
		else{
			services.next(".error").fadeOut();
		}
		
		if(message.val() == ""){
			message.next(".error").fadeIn();
		}
		else{
